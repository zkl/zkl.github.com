...
<tr class="list_out" onmouseover='this.className=&quot;list_over&quot;' onmouseout='this.className=&quot;list_out&quot;'>
	
	

		<TD language=javascript onmouseup="opencat(cat10<%=i%>000,&#13;&#10; img10<%=i%>000);" id=item$pval[catID]) style="CURSOR: hand" align=center width="25%">&nbsp;<IMG id=img10<%=i%>000 src="img/class1.gif" width=15 height=17></TD>
		<TD class="lineheight200" align="left" width="75%"><a href="Product.asp?BigClassName=<%=rsbig("BigClassName")%>"><%=rsbig("BigClassName")%></a></TD>
	...
	<TR>
		<TD id=cat10<%=i%>000 <%if rsbig("BigClassName")=BigClassName then 
		    ...
		    end if%> colspan="2" style="padding-left:10px; padding-top:5px; padding-bottom:5px;">
<%
dim rsSmall,sqls,j
...
sub ProductContent(intTitleLen)
   ...
   strTemp= strTemp & "<a href=ProductShow.asp?ID=" & rsProduct("id") & ">" & "<img src=" & rsProduct("DefaultPicUrl") & " width='180' height='140' border='0' >" & "</a><br></div>"  
   strTemp= strTemp & "</td>"
   ...
   strTemp= strTemp &"</TABLE>"
                ...
                strTemp= strTemp & "<td align=right width=70>"
...
sub SearchResultContent()
	...
	do while not rsSearch.eof
		...
		strTemp= strTemp & "<table width=100% border=0 cellspacing=3 cellpadding=0>"
                ...
                strTemp= strTemp & "<td>"
                strTemp= strTemp & "<a href=ProductShow.asp?ID=" & rsSearch("ID") & "><img src=images/arrow_7.gif border=0></a></td>"
                strTemp= strTemp & "</tr><tr>"
                strTemp= strTemp & "<td colspan=2>"
                strTemp= strTemp & "<table width=100% border=0 cellpadding=0 cellspacing=0>"
                strTemp= strTemp & "<tr>" 
                ...
                strTemp= strTemp & "</td>"
                strTemp= strTemp & "</tr><tr>" 
                strTemp= strTemp & "<td height=1 colspan=3 bgcolor=#eeeeee></td>"
                strTemp= strTemp & "</tr>"
                strTemp= strTemp & "</table>"
		response.write strTemp
		rsSearch.movenext
