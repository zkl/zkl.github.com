...
%>
	...
	<TR>
		<TD id=cat10<%=i%>000 style='DISPLAY: none' colspan="2"></tr>
...
%>
&nbsp;&nbsp;&nbsp;&nbsp;<IMG height=15 src="img/class3.gif" width=17 align=absMiddle border=0>&nbsp;&nbsp;&nbsp;&nbsp;<a href="Product.asp?BigClassName=<%=rsSmall("BigClassName")%>&Smallclassname=<%=rsSmall("SmallClassName")%>"><%=rsSmall("SmallClassName")%></a><BR>
...
sub ProductContent(intTitleLen)
   ...
   strTemp= strTemp & "<a href=ProductShow.asp?ID=" & rsProduct("id") & ">" & "<img src=" & rsProduct("DefaultPicUrl") & " width='180' height='150' border='0' onload='javascript:DrawImage(this);'>" & "</a><br></div>"  
   strTemp= strTemp & "</td>"
