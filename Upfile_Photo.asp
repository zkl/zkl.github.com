	...
	for each formName in upload.file '列出所有上传了的文件
		...
		if FoundErr<>true then
			...
			select case PhotoUrlID
				...
				case 7
					strJS=strJS & "parent.document.myform.FirstImageName.value='" & fileName & "';" & vbcrlf
					'strJS=strJS & "parent.document.myform.PhotoSize7.value='" & cstr(round(oFileSize/1024)) & "';" & vbcrlf	
				case 11
