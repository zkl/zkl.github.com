...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="center" valign="top"> <br> <table width="560" border="0" cellpadding="2" cellspacing="1" class="table_southidc">
        ...
        <tr> 
          <form method="post" name="myform" action="AdminAboutusModify.asp">
            ...
            <td><div align="center"> 
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                  <tr bgcolor="#ECF5FF"> 
                    ...
                    <td width="12%" bgcolor="#ECF5FF"><input name="Aorder" type="text" value="99999" size="4"></td>
                  ...
                  <tr bgcolor="#ECF5FF"> 
                    <td height="300" colspan="6"> <input type="hidden" name="content" value="<%=Server.HTMLEncode(rs("Content"))%>"> 
                      <iframe ID="eWebEditor1" src="Southidceditor/ewebeditor.asp?id=content" frameborder="0" scrolling="no" width="550" HEIGHT="450"></iframe> 
                    </td>
                  </tr>
                  <tr bgcolor="#ECF5FF"> 
