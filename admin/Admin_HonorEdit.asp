...
response.write "新闻内容不能为空!<a href=""javascript:history.go(-1)"">返回重输</a>"
response.end
end if
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="center" valign="top"> <br> <table width="560" border="0" cellpadding="2" cellspacing="1" class="table_southidc">
        <tr> 
          <td class="back_southidc" height="25"> <div align="center"><strong>修改新闻内容 <br>
              </strong></div></td>
        </tr>
        <tr> 
          <form method="post" name="myform" action="Admin_HonorEdit.asp?mark=Honor">
            <input type=hidden name=id value=<%=id%>>
            <td><div align="center"> 
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                  <tr bgcolor="#ECF5FF"> 
                    <td width="25%" height="25"> <div align="center">新闻内容</div></td>
                    <td width="75%" bgcolor="#ECF5FF"> <textarea name="explain" cols="50" rows="12"><%=rs("explain")%></textarea>                    </td>
                  </tr>
                  
                  <tr bgcolor="#ECF5FF"> 
                    <td height="22"> <div align="center">新闻图片</div></td>
                  ...
                  <tr> 
                    <td colspan="2"><div align="left"> 
                      图片上传：<iframe style="top:2px" ID="UploadFiles" src="../upload_Photo.asp?PhotoUrlID=5" frameborder=0 scrolling=no width="300" height="25"></iframe>
                      </div></td>
                  </tr>
                </table>
              </div></td>
