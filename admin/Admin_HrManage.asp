...
do while not rs.eof%>
              <table class="table_southidc" width="559" border="0" cellspacing="2" cellpadding="3">
                <tr> 
                  ...
                  <td bgcolor="#A4B6D7"><a href="Admin_HrManage.asp?id=<%=rs("ID")%>&amp;action=Del" onClick="return ConfirmDel();">删除</a>&nbsp;&nbsp;&nbsp;<!--<a href="AdminMaillist.asp?Email=<%=rs("email")%>&Name=<%=rs("uName")%>">发信</a> -->
                  </td>
                </tr>
                <%if rs("email")<>"" then%>
                <tr> 
                  <td height="10" bgcolor="#ECF5FF"> <div align="center">姓 名</div></td>
                  <td width="34%" bgcolor="#ECF5FF">&nbsp;&nbsp;<%=rs("uName")%></td>
                ...
                <tr> 
                  ...
                  <td bgcolor="#ECF5FF"> <div align="center"><font color="#FF0000">应聘日期</font></div></td>
