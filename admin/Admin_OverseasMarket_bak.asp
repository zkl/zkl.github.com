        ...
        <tr> 
          <form method="POST" action="Admin_OverseasMarket.asp?mark=southidc">
            <td><table width="100%" border="0" cellspacing="1" cellpadding="0">
                ...
                <tr> 
                  <td height="300" bgcolor="#ECF5FF"> <input type="hidden" name="content" value="<%=Server.HTMLEncode(rs_Market("OverseasMarket"))%>"> 
                ...
                <tr bgcolor="#ECF5FF"> 
                  <td height="300">
<input type="hidden" name="Encontent" value="<%=Server.HTMLEncode(rs_Market("EnOverseasMarket"))%>"> 
