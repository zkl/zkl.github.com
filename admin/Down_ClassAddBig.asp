...
if Action="Add" then
	...
	if FoundErr<>True then
		...
		if not (rs.bof and rs.EOF) then
			FoundErr=True
			ErrMsg=ErrMsg & "<br><li>新闻大类“" & BigClassName & "”已经存在！</li>"
		else
    	 	rs.addnew
    ...
    <td align="center" valign="top"><table width="80%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td align="center" valign="top"> <br>
            <strong>下 载 类 别 设 置</strong> <br> <form name="form1" method="post" action="Down_ClassAddBig.asp" onsubmit="return checkBig()">
              <table width="350" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#ECF5FF" class="border">
                <tr class="title"> 
                  <td height="25" colspan="2" align="center" bgcolor="#A4B6D7"><strong>新闻大类</strong></td>
                </tr>
                <tr class="tdbg"> 
                  <td width="126" height="22" bgcolor="#A4B6D7"> 
                    <div align="right"><strong>新闻名称：</strong></div></td>
                  <td width="218"> 
