...
if Action="Add" then
	...
	if SmallClassName="" then
		FoundErr=True
		ErrMsg=ErrMsg & "<br><li>新闻小类名不能为空！</li>"
	end if
	if FoundErr<>True then
		...
		if not rs.EOF then
			FoundErr=True
			ErrMsg=ErrMsg & "<br><li>“" & BigClassName & "”中已经存在新闻小类“" & SmallClassName & "”！</li>"
		else
     		rs.addnew
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
            ...
            <strong>下 载 类 别 设 置</strong> <br> <form name="form2" method="post" action="Down_ClassAddSmall.asp" onsubmit="return checkSmall()">
              <table width="350" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#ECF5FF" class="border">
                <tr bgcolor="#A4B6D7" class="title"> 
                  <td height="25" colspan="2" align="center"><strong>新闻小类</strong></td>
                </tr>
                <tr class="tdbg"> 
	...
	if rsBigClass.bof and rsBigClass.bof then
		response.write "<option>请先添加新闻大类</option>"
	else
