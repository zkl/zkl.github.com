...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="center" valign="top"><table width="90" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          <td align="center" valign="top"><br> <a href="Down_ClassAddBig.asp"><strong><font color="#FF0000"><u>添加新闻一级分类</u></font></strong></a><br> 
            <br> 
...
%>
              <tr bgcolor="#ECF5FF" class="tdbg"> 
                ...
                <td align="right" style="padding-right:10"><a href="Down_ClassAddSmall.asp?BigClassName=<%=rsBigClass("BigClassName")%>"><font color="#FF0000">添加二级分类</font></a> 
