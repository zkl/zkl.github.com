  ...
  <tr> 
    <td align="center" valign="top"><table width="650" border="0" cellpadding="2" cellspacing="1" class="table_southidc">
        <form method="POST" name="myform" onSubmit="return CheckForm();" action="Down_Save.asp?action=Add" target="_self">
          <tr> 
            <td class="back_southidc" height="30" colspan="3" align="center">添加新闻</td>
          </tr>
          <tr> 
            <td width="168" height="25" bgcolor="#ECF5FF"><font color="#FF0000">*</font>新闻名称：</td>
            <td colspan="2" bgcolor="#ECF5FF"> <input name="title" type="text" class="input" size="30"></td>
          </tr>
          <tr> 
            <td height="25" bgcolor="#ECF5FF"><font color="#FF0000">*</font>新闻类别：</td>
        ...
        rs.close
          ...
          <tr> 
            <td height="25" valign="top" bgcolor="#ECF5FF"><font color="#FF0000">*</font>新闻说明：</td>
          ...
          <tr> 
            <td height="25" bgcolor="#ECF5FF"><font color="#FF0000">*</font>附件标题：</td>
            <td colspan="2" bgcolor="#ECF5FF"> <input name="Softclass" type="text"  id="Softclass" value="" size="30"></td>
          </tr>
          <tr bgcolor="#ECF5FF"> 
          ...
          <tr bgcolor="#ECF5FF"> 
            <td height="25"><font color="#FF0000">*</font>新闻地址：</td>
