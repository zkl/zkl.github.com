    ...
    <td align="center" valign="top">
      <table width="650" border="0" cellpadding="2" cellspacing="1" class="table_southidc">
        <form method="POST" name="myform" onSubmit="return CheckForm();" action="Down_Save.asp?action=Modify" target="_self">
          <tr align="center"> 
            <td class="back_southidc" height="30" colspan="3"><font color="#0000FF"><strong>修改新闻</strong></font></td>
          </tr>
          <tr> 
            <td width="157" height="24" align="right" bgcolor="#ECF5FF"><font color="#FF0000">*</font>新闻名称：</td>
            <td colspan="2" valign="top" bgcolor="#ECF5FF">　 
              <input name="title" type="text" class="input" value="<%=rs_down("title")%>" size="30"></td>
          </tr>
          <tr> 
            <td height="24" align="right" bgcolor="#ECF5FF"><font color="#FF0000">*</font>新闻类别：</td>
            <td colspan="2" valign="top" bgcolor="#ECF5FF"> 　 
              <%
        ...
        rs.close
          ...
          <tr> 
            <td height="19" align="right" valign="top" bgcolor="#ECF5FF"><font color="#FF0000">*</font>新闻内容：</td>
          ...
          <tr> 
            <td height="24" align="right" bgcolor="#ECF5FF"><font color="#FF0000">*</font>附件标题：</td>
          ...
          <tr bgcolor="#ECF5FF"> 
            <td height="24" align="right"><font color="#FF0000">*</font>新闻地址：</td>
