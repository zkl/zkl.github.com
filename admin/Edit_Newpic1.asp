    ...
    <td align="center" valign="top"> <br> <strong><br>
      ...
      <table width="560" border="0" cellpadding="2" cellspacing="1" class="table_southidc">
        ...
        <tr class="tr_southidc"> 
          ...
          <FORM name=myform action="Edit_newpic1.asp?action=Edit" method=post>                    
                <tr bgcolor="#DFEBF2"> 
                  <td height="22"> 
                    <div align="center">图片地址：</div></td>
                  <td><input name="pic1" type="text" size="16" maxlength="20"></td>
                  <td height="22"> 
                    <div align="center">连接地址：</div></td>
                  <td><input name="movie1" type="text" size="16" maxlength="20"></td>
                  <td> 
