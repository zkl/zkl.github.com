...
{
   if(confirm("确定要删除此大类吗？删除此大类同时将删除所包含的小类和该类下的所有项目，并且不能恢复！"))
     return true;
   else
     return false;
...
{
   if(confirm("确定要删除此小类吗？删除此小类同时将删除该类下的所有项目，并且不能恢复！"))
     return true;
   else
     return false;
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="center" valign="top"><table width="90" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          <td align="center" valign="top"><br> <a href="News_ClassAddBig.asp"><strong><font color="#FF0000"><u>添加项目一级分类</u></font></strong></a><br> 
            <br> 
