...
%>
      ...
      <form name="del" method="Post" action="News_Del.asp" onSubmit="return ConfirmDel();">
        <table width="620" border="0" cellpadding="0" cellspacing="1" bgcolor="#000000">
          <tr bgcolor="#A4B6D7"> 
            <td height="25"><a href="News_Manage.asp">&nbsp;项目资讯管理</a> &gt;&gt; 
              <%
...
%> </td>
  	...
  	if rs.eof and rs.bof then
		response.write "共找到 0 条项目</td></tr></table>"
	else
		...
		response.Write "共找到 " & totalPut & " 条项目"
%> </td>
          </tr>
        </table>
        <%		
	    if currentPage=1 then
        	showContent
        	showpage strFileName,totalput,MaxPerPage,true,false,"条项目"
   	 	else
   	     	if (currentPage-1)*MaxPerPage<totalPut then
...
%>
        <table width="620" border="0" cellpadding="0" cellspacing="1" bgcolor="#000000" class="border" style="word-break:break-all">
          <tr bgcolor="#A4B6D7" class="title"> 
            ...
            <td width="246" align="center" bgcolor="#A4B6D7" >项目标题</td>
        ...
        <table width="620" border="0" cellpadding="0" cellspacing="0">
          <tr> 
            <td width="250" height="30"><input name="chkAll" type="checkbox" id="chkAll" onclick=CheckAll(this.form) value="checkbox">
              选中本页显示的所有项目</td>
            <td><input name="submit" type='submit' value='删除选定的项目'> 
      ...
      <br> <table width="620" border="0" cellpadding="0" cellspacing="0" class="border">
        <tr class="tdbg"> 
          <form name="searchsoft" method="get" action="News_Manage.asp">
            <td height="30"> <strong>查找项目：</strong> <input name="Title" type="text" class=smallInput id="Title3" size="20" maxlength="50"> 
              <input name="Query" type="submit" id="Query" value="查 询"> &nbsp;&nbsp;请输入项目名称。如果为空，则查找所有项目。</td>
          </form>
        </tr>
      </table></td>
  </tr>
