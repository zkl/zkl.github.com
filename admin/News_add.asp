  ...
  <tr> 
	...
	<table width="95%" border="0" cellpadding="2" cellspacing="1" class="table_southidc">
        <form method="POST" name="myform" onSubmit="return CheckForm();" action="News_save.asp?action=Add" target="_self">
          <tr> 
            <td class="back_southidc" height="30" colspan="2" align="center">增加项目</td>
          </tr>
          <tr bgcolor="#ECF5FF"> 
            <td width="119" height="25"><font color="#FF0000">*</font>项目标题：</td>
            <td width="476"> <input name="title" type="text" class="input" size="50" maxlength="200"></td>
          </tr>
          <tr bgcolor="#ECF5FF"> 
            <td height="25"><font color="#FF0000">*</font>项目类别：</td>
            <td> <%		
        ...
        rs.close
          ...
          <tr bgcolor="#ECF5FF"> 
            <td height="25" valign="top"><font color="#FF0000">*</font>项目内容：</td>
          ...
          <tr bgcolor="#ECF5FF"> 
            ...
            <td><input name="FirstImageName" type="text" id="FirstImageName" size="30" maxlength="50">&nbsp;<iframe style="top:2px" ID="FirstImageName" src="../upload_Photo.asp?PhotoUrlID=7" frameborder=0 scrolling=no width="300" height="25"></iframe>
              <br>
              首页的图片,直接从上传图片中选择： 
