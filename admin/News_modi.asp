    ...
    <td align="center" valign="top">
      <table  width="95%" border="0" cellpadding="2" cellspacing="1" class="table_southidc">
        <form method="POST" name="myform" onSubmit="return CheckForm();" action="News_save.asp?action=Modify" target="_self">
          <tr align="center"> 
            <td class="back_southidc" height="30" colspan="2"><font color="#0000FF"><strong>修改项目</strong></font></td>
          </tr>
          <tr bgcolor="#ECF5FF"> 
          ...
          <tr bgcolor="#ECF5FF"> 
            <td height="24" align="right"><div align="left"><font color="#FF0000">*</font>项目类别：</div></td>
            <td valign="top"> 　 
              <div align="left">
                <%			
        ...
        rs.close
          ...
          <tr bgcolor="#ECF5FF"> 
            <td align="right" valign="top"><div align="left"><font color="#FF0000">*</font>项目内容：</div></td>
            <td valign="top">
          ...
          <tr bgcolor="#ECF5FF"> 
            ...
            <td valign="top"><input name="FirstImageName" type="text" id="FirstImageName" value="<%=rs_news("FirstImageName")%>" size="30" maxlength="200">
			<iframe style="top:2px" ID="FirstImageName" src="../upload_Photo.asp?PhotoUrlID=7" frameborder=0 scrolling=no width="300" height="25"></iframe> 
            </td>
          </tr>
          <tr bgcolor="#ECF5FF"> 
...
<div align="left">
          ...
          <tr bgcolor="#ECF5FF" style="display:none"> 
            <td height="24" align="right"><div align="left">首页图片项目：</div></td>
            <td>　 
              <div align="left">
                ...
                否 　<font color="#FF0000">（设为首页图片项目，选择此项时请注意文章中是否添加有图片！）</font></div></td>
          </tr>
