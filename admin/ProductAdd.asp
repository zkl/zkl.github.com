...
<form method="POST" name="myform" action="ProductSave.asp?action=add" target="_self">
        ...
        rs.close
           ...
           id="spec" size="50" maxlength="80"></td>
                </tr>
                <tr>
                ...
                <tr> 
                  ...
                  <td width="214" height="21" bgcolor="#E3E3E3"> <input name="DefaultPicUrl" type="text" id="DefaultPicUrl" size="30" maxlength="50">                  </td>
                  <td width="231" bgcolor="#E3E3E3"><iframe style="top:2px" ID="UploadFiles" src="../upload_Photo.asp?PhotoUrlID=6" frameborder=0 scrolling=no width="300" height="25"></iframe>                  </td>
                </tr>
                <tr> 
