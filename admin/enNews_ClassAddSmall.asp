...
if Action="Add" then
	...
	if FoundErr<>True then
		...
		rs.open "Select * From enSmallClass_New Where BigClassName='" & BigClassName & "' AND SmallClassName='" & SmallClassName & "'",conn,1,3
		if not rs.EOF then
			FoundErr=True
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="center" valign="top"> <table width="80%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td align="center" valign="top"> <br> <strong>新 闻 类 别 设 置</strong> <br> 
            <form name="form2" method="post" action="enNews_ClassAddSmall.asp" onSubmit="return checkSmall()">
	...
	rsBigClass.open "Select * From enBigClass_New",conn,1,1
