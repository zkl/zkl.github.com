...
rs.Open "Select * from enBigClass_New where BigClassID=" & CLng(BigClassID),conn,1,3
	...
	if Action="Modify" then
		...
		if FoundErr<>True then
			...
			if NewBigClassName<>OldBigClassName then
				conn.execute "Update enSmallClass_New set BigClassName='" & NewBigClassName & "' where BigClassName='" & OldBigClassName & "'"
				conn.execute "Update enNEWS set BigClassName='" & NewBigClassName & "' where BigClassName='" & OldBigClassName & "'"
     		end if		
			call CloseConn()
     		Response.Redirect "enNews_ClassManage.asp" 
		end if
    ...
    <td align="center" valign="top"><table width="80%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td align="center" valign="top"><br>
            <strong>新 闻 类 别 设 置</strong> <br> <br> <form name="form1" method="post" action="enNews_ClassModifyBig.asp">
