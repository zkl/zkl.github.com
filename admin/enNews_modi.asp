...
sql="select * from enNews where ID=" & ID & ""
...
sql = "select * from enSmallClass_New order by SmallClassID asc"
  ...
  <tr> 
    <td align="center" valign="top">
      <table  width="95%" border="0" cellpadding="2" cellspacing="1" class="table_southidc">
        <form method="POST" name="myform" onSubmit="return CheckForm();" action="enNews_save.asp?action=Modify" target="_self">
          <tr align="center"> 
        ...
        rs.close
			%>
                ...
                <select name="SmallClassName">
                  ...
                  <%
			sql="select * from enSmallClass_New where BigClassName='" & rs_news("BigClassName") & "'" 
			rs.open sql,conn,1,1 
