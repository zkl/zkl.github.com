...
$(document).ready(function(){
	...
	$(".lighterBox .workIcon_s a").lightBox({
		txtImage: '图片',
		txtOf: ' 总',
	...
	$(".topLinks a,.workIcon_s a,.withTip").poshytip({
		className: 'tip-blue',
		bgImageFrameSize: 9,
		offsetX: 0,
		offsetY: 20,
	...
	$.ajax({
		...
		success:function(data){
			...
			for(var i=0;i<data.length;i++){
				...
				html += '<div class="workIcon_s"><a href="'+public_root+'/upload/'+images[1]+'" title="'+data[i].title+'"><img src="'+public_root+'/upload/'+images[0]+'" alt="" /></a></div>';
