...
{
	var unit_id     = "2279014";
	var client_ip   = "119.167.195.168";
	var server_time = "1356660879";
	var verify_code = "7c09353a";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/2279014/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
